...
class KCAPTCHA {
    ...
    function KCAPTCHA() {
        ...
        $allowed_symbols = "23456789abcdeghkmnpqsuvxyz"; // Do not put similar characters (o=0, 1=l, i=j, t=f)
        $fontsdir = '../files/system/captcha';
        $length = mt_rand(4, 5);
        $width = 100;
        $height = 50;
...
// Process the request on the picture CAPTCHA
session_name('SESID');
session_start();
